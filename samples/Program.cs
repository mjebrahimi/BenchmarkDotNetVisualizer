...
await summary1.SaveAsHtmlAndImageAsync(
    htmlPath: DirectoryHelper.GetPathRelativeToProjectDirectory("Reports\\JsonSerializers\\Benchmark-Dark.html"),
    imagePath: DirectoryHelper.GetPathRelativeToProjectDirectory("Reports\\JsonSerializers\\Benchmark-Dark.png"),
    options: new ReportHtmlOptions
    {
        Title = "Json Serializers Benchmark",
        GroupByColumns = ["Method"],                          // Colorizes 'Mean' and 'Allocated' columns as Spectrum
        ...
        DividerMode = RenderTableDividerMode.EmptyDividerRow, // Separates tables by Empty Divider Row
        HtmlWrapMode = HtmlDocumentWrapMode.Simple,
        ThemeOption = HtmlThemeOptions.Dark
    });
...
await summary2.SaveAsHtmlAndImageAsync(
    htmlPath: DirectoryHelper.GetPathRelativeToProjectDirectory("Reports\\Iterators\\Benchmark-Dark.html"),
    imagePath: DirectoryHelper.GetPathRelativeToProjectDirectory("Reports\\Iterators\\Benchmark-Dark.png"),
    options: new ReportHtmlOptions
    {
        Title = "Performance Comparison between for, foreach, and ForEeach() method",
        GroupByColumns = ["Runtime"],
...
await summary2.JoinReportsAndSaveAsHtmlAndImageAsync(
    htmlPath: DirectoryHelper.GetPathRelativeToProjectDirectory("Reports\\Iterators\\JoinedBenchmark-PivotBy-Runtime-Dark.html"),
    imagePath: DirectoryHelper.GetPathRelativeToProjectDirectory("Reports\\Iterators\\JoinedBenchmark-PivotBy-Runtime-Dark.png"),
    options: new JoinReportHtmlOptions
    {
        Title = "Performance Comparison between for, foreach, and ForEeach() method",
        MainColumn = "Method",
...
await summary2.JoinReportsAndSaveAsHtmlAndImageAsync(
    htmlPath: DirectoryHelper.GetPathRelativeToProjectDirectory("Reports\\Iterators\\JoinedBenchmark-PivotBy-Method-Dark.html"),
    imagePath: DirectoryHelper.GetPathRelativeToProjectDirectory("Reports\\Iterators\\JoinedBenchmark-PivotBy-Method-Dark.png"),
    options: new JoinReportHtmlOptions
    {
        Title = "Performance Comparison between for, foreach, and ForEeach() method",
        MainColumn = "Runtime",
